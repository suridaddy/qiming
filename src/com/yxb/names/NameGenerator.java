...
public class NameGenerator {
    ...
    private static void generateNames(int totalLength, boolean onlyJi) throws IOException {
        ...
        File nameFile = new File("/home/everest/Documents/Personal/名字/generatedNames.txt." + totalLength);
        if (nameFile.exists()) {
            nameFile.renameTo(new File("/home/everest/Documents/Personal/名字/generatedNames.txt." + totalLength + ".bak"));
        }
